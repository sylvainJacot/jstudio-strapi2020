...
export const pathblog = "/blog-posts";
...
export const Skills = [
  {
    ...
    quote:
      '" I understand the perfect user interface should look good and work even better. "',
  ...
  },
  {
    ...
    quote:
      '"I understand the scope, requirements, and technical restraints of the project I am currently working on."',
  ...
  },
  {
    ...
    quote:
      "I understand that quality is not just about the retouching itself but also about the added value of service that you provide",
...
export const UIUXProjects = [
  {
    ...
    roles: [
      ...
      },
      {
        titlerole: "Role",
        descriptionrole:
          "Design the entire platform based on the wireframes provided. Implement atomic components (html/css)",
      },
      {
        titlerole: "Time",
    ...
    methodology: [Trello, AtomicDesign, Sketch, Agile, Invision, Html5, Sass],
    images: [
      {
  ...
  },
  {
    ...
    roles: [
      ...
      },
      {
        titlerole: "Role",
        descriptionrole:
          "The Samsung Members app have got some updates and wants to inform the clients via its website. Plus, retain the audience via monthly newsletters. I had to Keep consistency and design regarding all technical contraints (Samsung guidelines)",
      },
      {
        titlerole: "Time",
  ...
  },
  {
    ...
    description:
      "Kia Motors Corporation is a South Korean multinational automotive manufacturer headquartered in Seoul. ",
    roles: [
      {
        titlerole: "Team",
      ...
      },
      {
        titlerole: "Role",
        descriptionrole:
          "I had to create/imagine a landing page and advertising posters for the promotion of the new Kia SUV's. I had to retouch the car's pictures as well ",
      },
      {
        titlerole: "Time",
  ...
  },
  {
    ...
    description:
      " Telenet specialises in the supply of broadband internet, fixed and mobile telephony services and cable television to customers throughout Flanders and Brussels over a powerful HFC (hybrid fibre-coax) network",
    roles: [
      {
        titlerole: "Team",
      ...
      },
      {
        titlerole: "Role",
        descriptionrole:
          'Create an interface in order to present the concept of the Digicovers (custom adhesive sheets that cover client\'s Digicorder). And create the home page in order to promote the "Signal switch".',
      },
      {
        titlerole: "Time",
    ...
    methodology: [Sketch, PixelPerfect, Agile, Invision, Zeplin],
    images: [
      {
...
export const CreativeDeveloperProjects = [
  {
    ...
    roles: [
      ...
      },
      {
        titlerole: "Role",
        descriptionrole:
          "(re)-Design of the website and implementation with in html/css/js",
      },
      {
        titlerole: "Website",
    ...
    methodology: [Sketch, Html5, Sass, Javascript, Bootsrap, Git],
    images: [
      {
  ...
  },
  {
    ...
    roles: [
      ...
      },
      {
        titlerole: "Role",
        descriptionrole:
          "Design the entire platform based on the wireframes provided. Integration of the website (html/css)",
      },
      {
        titlerole: "Website",
    ...
    methodology: [Sketch, Html5, CSS3, Git],
    images: [
      {
...
export const PhotoRetoucherProjects = [
  {
    ...
    description:
      "The Eat Brussels Festival promote great names in Brussels gastronomy",
  ...
  },
  {
    ...
    slug: "PrimeMinister",
    description:
      "Charles Michel is a Belgian politician who was Prime Minister of Belgium between 2014-2019",
